...
df_beers = read.csv("Project_EDA_1/Beers.csv",header = TRUE)
#Reading the brewery dataset
df_breweries_1 = read.csv("Project_EDA_1/Breweries.csv",header = TRUE)
df_states = read.csv("Project_EDA_1/States.csv",header=TRUE)
