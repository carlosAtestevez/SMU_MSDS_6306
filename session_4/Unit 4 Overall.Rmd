...
#filtering
data_long %>% filter(condition == "Control") %>% ggplot(aes(x = age, y = measurement)) + geom_point()+geom_smooth()
...
#Url https://api-v2.intrinio.com/companies/AAPL?api_key=OmNmNjQ3MWI2OTFhNTk5ZTMwOGYzNjBhNDIyNjE2NWRh
#key = OjhjZWUxNmFiZjUzZTdkNjUwNDg5ZTJiODNhMWI2MDE1
