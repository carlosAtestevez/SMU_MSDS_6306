...
author: "Carlos Estevez and Haitie Liu"
date: "2023-02-17"
output: 
  html_document:
    css: "bootstrap.css"
...
<div class="alert alert-dismissible alert-warning">
<h3><strong>Analysis top Breweries(The Big 5)</strong></h3>
...
<p>
This analysis can reinforce the previous analysis. Again, Budweiser can allocate beer types according to the different Consumer tastes and preferences aiming to atract more clients ang increase the sales revenue. We can see from the map that Colorado 
