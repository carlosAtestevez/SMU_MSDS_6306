...
# df_std_os = select(df_std_1,Attrition,MonthlyIncome,YearsAtCompany,OverTimeN,TotalWorkingYears,YearsAtCompany,StockOptionLevel)
# df_std_os$MonthlyIncome = df_std_os$MonthlyIncome / 1000
# 
# 
# df_std_smote_result = SMOTE(df_std_os[,c(2:6)],df_std_os$Attrition,K = 15)
# df_std_smote_0 = df_std_smote_result$data
# df_std_smote_sync = df_std_smote_result$syn_data
# #colnames(df_std_smote_0)[5] = "Attrition"


df_std_unp = oversampling(df_std_1)
df_std_unp$MonthlyIncome = scale(df_std_unp$MonthlyIncome) #/ 100
  df_data_model_0 = select(df_std_unp,Attrition,MonthlyIncome,YearsAtCompany,OverTimeN,JobLevelN,JobSatisfactionN,MaritalStatusN)
#df_data_model_0 = select(df_std_unp,Attrition,MonthlyIncome,YearsAtCompany,OverTimeN,StockOptionLevelN,JobInvolvementN,JobLevelN)
...
for(ki in 1:lst_ki_index){
  knn_results = knn(df_lst_train[,c(2:6)], df_lst_test[,c(2:6)], df_lst_train$Attrition, k = ki, prob = TRUE)
  #knn_results = knn(df_lst_train[,c(2:6)], df_lst_test[,c(2:6)], df_lst_train$Attrition, k = ki, prob = TRUE)
...
#Stock Option Level
table(df_std_1$StockOptionLevel,df_std_1$Attrition) #Don't like
...
#Winners-->Overtime, JobSatisfaction, JobLevel, Maritial Status Maybe
